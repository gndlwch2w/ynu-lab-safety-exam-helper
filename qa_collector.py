...
headers = {
    # TODO: filling in your accesing cookies
    'Cookie': 'DWRSESSIONID=ujmPs~JMKVP06AyG!TBZl3lBiLBHTm5QeIo; JSESSIONID=CE097C12C47662658AFB3F77EF6B3C60; pgv_pvi=7130572800; pgv_si=s2102130688; sensorsdata2015jssdkcross=%7B%22distinct_id%22%3A%2212023215258%22%2C%22first_id%22%3A%22189909e6223957-0b7b2af0cfef08-26031d51-2073600-189909e62241056%22%2C%22props%22%3A%7B%7D%2C%22%24device_id%22%3A%22189909e6223957-0b7b2af0cfef08-26031d51-2073600-189909e62241056%22%7D',
...
def get_qa(pid, eid, eaid='0'):
    ...
    sp = BeautifulSoup(requests.get(
        url, params=params, headers=headers).text, 'lxml')
    qa_list = {}
...
def collect_qa(out_fn='qa_bank/lab_qa_v{version}.json', encoding='utf-8'):
    ...
    for _, v in qa_map.items():
        unique_qa.update(v)
    print('Total number of the qa:', len(unique_qa))
